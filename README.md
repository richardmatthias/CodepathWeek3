...
1. Map view and forward/reverse-geocoding is very complex and functionalities require much more research
2. Complex segue interactions between views from differen entry points (button does one thing, tab bar does another, etc.)

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/NODxrgD.gifv' title='Video Walkthrough' width='' alt='Video Walkthrough' />
